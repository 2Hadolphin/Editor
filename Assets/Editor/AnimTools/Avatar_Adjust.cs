...
public class Avatar_Adjust_ED : Editor
{
    ...
    public override void OnInspectorGUI()
    {
...

        {
            ...
            if (GUILayout.Button("Select Avatar", mEditorUtility.MiddleLittleButton(5)))
            {
                mEditorUtility.OpenFile(ref path, ref newAvatar);
            }
            if (avatar != newAvatar)
            {
                avatar = newAvatar;
...

        {
            ...
            string _path = null;
            if (GUILayout.Button("Select Skeleton" ,mEditorUtility.MiddleLittleButton(5)))
            {
                mEditorUtility.OpenFile(ref _path, ref ob);
            }
        ...
        if (GUILayout.Button("Search", mEditorUtility.MiddleLittleButton(3)))
        {
            {
        ...
        if (GUILayout.Button("Archive", mEditorUtility.MiddleLittleButton(3)))
        {
            if (editing)
            {
...

        {
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.TextField(skeleton.humanName, mEditorUtility.MiddleLittleButton(4));
                EditorGUILayout.TextField(skeleton.boneName, mEditorUtility.MiddleLittleButton(4));
                EditorGUILayout.FloatField("AxisLength",skeleton.limit.axisLength, mEditorUtility.MiddleLittleButton(4));
                GUILayout.EndHorizontal();
            }
...

        {
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.TextField(skeleton.name, mEditorUtility.MiddleLittleButton(4));
                EditorGUILayout.Vector3Field("Position",skeleton.position, mEditorUtility.MiddleLittleButton(4));
                EditorGUILayout.Vector3Field("Rotation", skeleton.rotation.eulerAngles, mEditorUtility.MiddleLittleButton(4));
                EditorGUILayout.Vector3Field("Scale", skeleton.scale, mEditorUtility.MiddleLittleButton(4));
