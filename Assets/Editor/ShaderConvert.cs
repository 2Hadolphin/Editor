    ...
    public class ShaderConvert : OdinEditorWindow//ScriptableWizard
    {
        ...
        public class ShaderSelector
        {
            ...
            public void LoadShaders()
            {
                ...
                if (AssetDatabase.IsValidFolder(AssetDatabase.GetAssetPath(obj)))
                {
                    ...
                    shaders = new HashSet<Shader>(mEditorUtility.GetAssetsAtPath<Shader>(AssetDatabase.GetAssetPath(obj), child));
                }
        ...
        public void LoadMats(params UnityEngine.Object[] targets)
        {
            ...
            foreach (var obj in targets)
            {
                ...
                {
                    var child = EditorUtility.DisplayDialog("Inculde ChildFolder", "Search child folder ?", "Yes.", "No.");
                    LoadMats(mEditorUtility.GetAssetsAtPath<Material>(AssetDatabase.GetAssetPath(obj), child));
                }
        ...
        {
            var path = mEditorUtility.ChoseFolder();
            ...
            mSystemIO.SaveJson(path, "ShaderConvertData_" + Source.Shader.name.Replace('/', '$') + "-" + Target.Shader.name.Replace('/', '$'), config);
            AssetDatabase.Refresh();
        }
        ...
        public void LoadConfigData()
        {
            ...
            var p = mSystemIO.LoadJson<Config>(path);
